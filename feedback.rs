    ...
    E: GenericVM<VS, Code, By, Loc, Addr, SlotTy, Out, I, S, CI>,
{
        ...
        OT: ObserversTuple<S>,
    {
        ...
        // RL: bug found reward
        if is_any_bug_hit {
            crate::rl_scheduler::set_reward_signal(state, 0.0, false, true);
        }
        Ok(is_any_bug_hit)
    }
}
    ...
    CI: Serialize + DeserializeOwned + Debug + Clone + ConciseSerde,
{
        ...
        OT: ObserversTuple<S0>,
    {
        ...
        let mut cmp_improvement_count: f64 = 0.0; // RL
        ...
        // RL: inject reward signal
        crate::rl_scheduler::set_reward_signal(
            state,
            cmp_improvement_count,
            cov_interesting,
            false,
        );
